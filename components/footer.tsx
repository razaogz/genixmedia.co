...
const FOOTER_LINKS: Record<string, { label: string; href: string }[]> = {
  ...
  Solutions: [
    ...
    { label: 'PR & Reputation', href: '/solutions/reputation' },
    { label: 'Growth & Acquisition', href: '/solutions/growth' },
    { label: 'SaaS & Software', href: '/solutions/technology' },
  ],
  Services: [
    { label: 'Online Presence Optimization', href: '/solutions/growth' },
    { label: 'Personal Branding', href: '/solutions/reputation' },
    { label: 'Verification Consulting', href: '/solutions/digital-assets' },
    { label: 'Digital Advisory', href: '/contact' },
  ],
  Resources: [
    { label: 'FAQ', href: '/#faq' },
